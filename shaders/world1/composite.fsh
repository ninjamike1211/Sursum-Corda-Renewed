...
#include "/program/composite_fragment.glsl"
...
// 		// Sun disk
// 		float sunDisk = smoothstep(0.985, 0.987, dot(normalize(viewPos), lightDirView));
// 		vec3 sunDiskColor = mix(10*vec3(5.0, 3.0, 20.0), vec3(0.0), smoothstep(0.985, 0.9865, dot(normalize(viewPos), lightDirView)));
