...
// ------------------------- Reflections ------------------------
    ...
    // ------------- Fallback Sky color and Clouds --------------
        ...
        // Apply clouds
        #ifdef cloudsEnable
            applyEndCloudColor(eyeDir, vec3(1.0, 1.0, -1.0) * eyePos + vec3(0.0, eyeAltitude, 0.0), skyColor, -skyDirect);
        #endif
...
//         // Apply clouds
//         #ifdef cloudsEnable
//             applyEndCloudColor(eyeDir, vec3(1.0, 1.0, -1.0) * eyePos + vec3(0.0, eyeAltitude, 0.0), skyColor, -SunMoonColor);
//         #endif
